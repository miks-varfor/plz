...
?>
<h1>Tilisiirrolla suoritetut jäsenmaksut</h1>

<form action="listBankPaid" method="get">
...
?>
<p><a href="listBankPaid?<?php echo http_build_query($queryParts)?>">Listaus tekstimuodossa</a></p>
